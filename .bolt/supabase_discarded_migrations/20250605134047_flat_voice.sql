...
VALUES 
  ('openai', current_setting('app.openai_key', true), '{"model": "gpt-4-turbo-preview"}'),
  ('gemini', current_setting('app.gemini_key', true), '{"model": "gemini-pro"}'),
  ('anthropic', current_setting('app.anthropic_key', true), '{"model": "claude-3-opus-20240229"}')
