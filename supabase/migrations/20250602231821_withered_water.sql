/*
  ...
  2. Hypertables
    - Convert performance metrics to hypertable
    - Convert client journeys to hypertable
    - Add proper indexing for time-series data
...
CREATE TABLE IF NOT EXISTS system_health_metrics (
  ...
  CONSTRAINT system_health_metrics_pkey PRIMARY KEY (ts, metric_name)
);
